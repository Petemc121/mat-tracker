...
describe("create member page", () => {
    it("should have a form with all required fields", () => {
        const { getByText, getAllByRole, getByRole } = (0, react_1.render)((0, jsx_runtime_1.jsx)(react_router_dom_1.BrowserRouter, { children: (0, jsx_runtime_1.jsx)(CreateMemberPage_1.default, {}, void 0) }, void 0));
    ...
    it("should call handle change function on change of inputs", () => {
        ...
        const { getByTestId } = (0, react_1.render)((0, jsx_runtime_1.jsx)(react_router_dom_1.BrowserRouter, { children: (0, jsx_runtime_1.jsx)(CreateMemberPage_1.default, { handleChange: handleChange }, void 0) }, void 0));
    ...
    it("should call handle submit function on submit", () => {
        ...
        const { getByTestId } = (0, react_1.render)((0, jsx_runtime_1.jsx)(react_router_dom_1.BrowserRouter, { children: (0, jsx_runtime_1.jsx)(CreateMemberPage_1.default, { handleSubmit: handleSubmit }, void 0) }, void 0));
